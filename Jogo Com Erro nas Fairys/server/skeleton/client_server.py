...
class ClientThread(Thread):
    ...
    def process_get_fairy_position(self):
        fairy_position = self.gamemech.get_fairy_position()
        self.current_connection.send_obj(fairy_position, server.INT_SIZE)
...
#    result = self.mathserver.sym(a)
    ...
    def dispatch_request(self) -> (bool, bool):
        ...
        elif request_type == server.GET_FAIRY_POSITION_OP:
            logging.info("Asking for fairy position: " + str(self.address))
            self.process_get_fairy_position()
